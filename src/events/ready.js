...
      // ==================================
      const guildId = "1460132346081837203"; // 
      const channelId = "1460136283891437679"; // 
...
          selfMute: false
        });
        startupLog(`Voice Channel Connected permanently in guild: ${guild.name}`);
      } else {
        logger.error(`Could not find guild with ID: ${guildId} for voice connection.`);
      }
      // ===================================================================
